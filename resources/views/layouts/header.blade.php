<header x-data="{ open: false }"
    ...
    <div class="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <nav class="hidden md:flex items-center gap-8 font-medium">
            ...
            <a href="{{ route('blogs') }}" class="hover:text-purple-200">Blog</a>
        </nav>
        ...
        <div class="hidden md:flex items-center gap-4">
            ...
            <!-- Social Media -->
            <!-- Instagram -->
            <a href="https://www.instagram.com/lkp_unsada/" target="_blank"
            ...
            <!-- Email -->
            <a href="mailto:upklpk@gmail.com" class="hover:text-purple-300 transition">
            ...
            <!-- WhatsApp -->
            <a href="https://wa.me/6288214140008" target="_blank" class="hover:text-green-400 transition">
    ...
    <div x-show="open" x-transition class="md:hidden px-6 pb-6 space-y-4">
        ...
        <a href="{{ route('blogs') }}" class="block">Blog</a>
        <a href="{{ route('login') }}"
