    ...
    <div id="app">
        ...
        <aside class="aside is-placed-left is-expanded">
            ...
            <div class="menu is-menu-main">
                ...
                <ul class="menu-list">
                    <li class="hidden">
                        <a href="https://themewagon.com" target="_blank" class="has-icon">
                            <span class="icon"><i class="mdi mdi-credit-card-outline"></i></span>
                            <span class="menu-item-label">Premium Demo</span>
                        </a>
                    </li>
                    <li>
                        <a href="https://themewagon.com/themes/free-tailwind-css-html5-admin-dashboard-template-admin-one/"
                            target="_blank" class="has-icon">
                            <span class="icon"><i class="mdi mdi-help-circle"></i></span>
                            <span class="menu-item-label">About</span>
                        </a>
                    </li>
                    <li>
                        <a href="https://github.com/themewagon/admin-one" class="has-icon">
